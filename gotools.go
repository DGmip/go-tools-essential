...
func Logger(devmode, ssl bool, host string, port_num string, route, appid, origin string) *mlog.MultiLogger { return mlog.Connect(devmode, ssl, host, port_num, route, appid, origin) }
