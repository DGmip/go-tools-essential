...
func URL_get_bytes(logs chan string, url string) (bool, []byte) {
	...
	logs<-"TOOLS/URL/GET FAILED ENDPOINT: "+url
	return false, nil
}
...
func Logger(devmode, ssl bool, host string, port_num string, route, appid, origin string) (bool, *mlog.MultiLogger) { return mlog.Connect(devmode, ssl, host, port_num, route, appid, origin) }
